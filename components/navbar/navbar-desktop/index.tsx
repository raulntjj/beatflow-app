...
export default function NavbarDesktop() {
  ...
  return (
    <aside className="relative hidden md:block tablet:w-fit xl:w-[244px]">
      <div className="relative z-10 h-full p-1 tablet:p-4 bg-background border-r-[2px] border-zinc-700 ">
      ...
      <div
        className={`absolute z-0 top-0 left-full h-full tablet:w-[244px] bg-background border-r-[2px] border-zinc-700
        shadow-lg p-4 
