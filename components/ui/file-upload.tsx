    ...
    <div className="w-full" {...getRootProps()}>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="relative z-20 text-center font-sans font-normal text-foreground text-xl mt-2">
            Arraste ou solte seus arquivos aqui
          </p>
          <div className="relative w-full my-10 max-w-xl mx-auto">
            {files.length > 0 &&
              files.map((file, idx) => (
                <motion.div
                  key={"file" + idx}
