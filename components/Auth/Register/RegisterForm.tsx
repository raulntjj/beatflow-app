...
export default function RegisterForm() {
    ...
    try {
      const response = await fetch(`${process.env.NEXTAUTH_URL}/api/register`, {
        ...
        body: JSON.stringify({
          ...
          bio: "",
          is_private: 0,
          profile_photo_path: "beatflow/profile_photos/Mr5GkoO88cPfBMRb6dGnBhuNtvwtbo1HX63CCUuA.jpg"
        }),
      });
  ...
  return (
    <div className="relative z-10 w-full h-full max-w-md p-8 rounded-xl m-auto">
      ...
      />
      <h2 className="text-base font-semibold text-center mb-6">Crie sua conta</h2>
